...
<div class = "row">
    <div class = "col-xs-12 col-sm-12 col-lg-12">
        ...
        echo common\widgets\jsoneditor\JsonEditor::widget([
            ...
            //'schemaUrl' => Yii::getAlias('@web/js/json-editor/schema/article.before_body.json')
            //'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=page-body.json')
            'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=article-before_body')
        ]);
        ?>
    </div>
</div>
...
<div class = "row">
    <div class = "col-xs-12 col-sm-12 col-lg-12">
        ...
        echo common\widgets\jsoneditor\JsonEditor::widget([
            ...
            //'schemaUrl' => Yii::getAlias('@web/js/json-editor/schema/article.after_body.json')
            //'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=page-body.json')
            'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=article-after_body')
        ]);
        ?>
    </div>
</div>
