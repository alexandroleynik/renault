...
<div class = "row">
    <div class = "col-xs-12 col-sm-12 col-lg-12">
        ...
        echo common\widgets\jsoneditor\JsonEditor::widget([
            ...
            'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=block-before_body&language=' . Yii::$app->language . '&domain_id=' . \Yii::$app->user->identity->domain_id)
        ]);
        ?>
    </div>
</div>
...
<div class = "row">
    <div class = "col-xs-12 col-sm-12 col-lg-12">
        ...
        echo common\widgets\jsoneditor\JsonEditor::widget([
            ...
            'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=block-after_body&language=' . Yii::$app->language . '&domain_id=' . \Yii::$app->user->identity->domain_id)
        ]);
        ?>
    </div>
</div>
