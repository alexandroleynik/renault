...
<div class="text-block-form">
    ...
    <?php echo $form
        ->field($model, 'key')        
        ->dropDownList(['frontend.code.head.end' => Yii::t('backend', 'Add to head end'), 'frontend.code.body.end' => 'Add to body end' ])        
        ?>
    ...
    <?php
    echo $form->field($model, 'body')->textarea()->hint(Yii::t('backend', '*wrap with script tag'));
