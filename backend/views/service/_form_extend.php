...
<div class = "row">
    <div class = "col-xs-12 col-sm-12 col-lg-12">
        ...
        echo common\widgets\jsoneditor\JsonEditor::widget([
            ...
            'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=service-before_body&language=' . Yii::$app->language)
        ]);
        ?>
    </div>
</div>
...
<div class = "row">
    <div class = "col-xs-12 col-sm-12 col-lg-12">
        ...
        echo common\widgets\jsoneditor\JsonEditor::widget([
            ...
            'schemaUrl' => Yii::getAlias('@apiUrl/file/schema/view?id=service-after_body&language=' . Yii::$app->language)
        ]);
        ?>
    </div>
</div>
