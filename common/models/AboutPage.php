...
use common\models\query\AboutPageQuery;
 ...
 * @property AboutPageCategory $category
 * @property AboutPageAttachment[] $aboutPageAttachments
 */
class AboutPage extends \yii\db\ActiveRecord
{
    ...
    {
        return new AboutPageQuery(get_called_class());
    }
    ...
    public function behaviors()
    {
        return [
            ...
            [
                ...
                'multiple'       => true,
                'uploadRelation' => 'aboutPageAttachments'
            ],
            [
                'class'            => UploadBehavior::className(),
                'attribute'        => 'thumbnail',
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'targetClass' => AboutPageCategory::className(), 'targetAttribute' => 'id'],
            [['author_id', 'updater_id', 'status', 'weight', 'about_id', 'domain_id'], 'integer'],
    ...
    public function beforeSave($insert)
    {
        if (parent::beforeSave($insert)) {
            ...
            if ($this->slug and $this->about_id and $this->isNewRecord and 'extend'
                != $this->on_scenario) {
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if (!empty($this->categoriesList)) {
            ...
            foreach ($this->categoriesList as $categoryId) {
                $model                  = new AboutPageCategories();
                $model->about_page_id = $this->id;
    ...
    {
        return $this->hasMany(AboutPageCategories::className(), ['about_page_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getAboutPageAttachments()
    {
        return $this->hasMany(AboutPageAttachment::className(), ['about_page_id' => 'id']);
    }
