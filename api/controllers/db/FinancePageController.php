...
/**
 * Class FinancePageController
 * @author Eugene Terentev <eugene@terentev.net>
 */
class FinancePageController extends ActiveController
{
    /**
     * @var string
     */
    public $modelClass = 'api\models\FinancePage';
