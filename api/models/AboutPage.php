...
class AboutPage extends \common\models\AboutPage implements Linkable
{
    ...
    {
        return ['id', 'slug', 'category_id', 'about_id', 'title', 'head', 'body', 'published_at', 'thumbnail_base_url', 'thumbnail_path', 'domain_id', 'description', 'before_body', 'after_body', 'on_scenario', 'locale'];
    }
